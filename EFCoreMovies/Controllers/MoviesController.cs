...
namespace EFCoreMovies.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        //    return await context.Set<MovieWithCounts>().AsNoTracking().Where(p => p.AmountCinemas > 0).ToListAsync();
        //}
        ...
        public async Task<ActionResult<MovieDTO>> GetWithAutoMapper(int id)
        {
            var movieDTO = await context.Movies
                .ProjectTo<MovieDTO>(mapper.ConfigurationProvider).FirstOrDefaultAsync(m => m.Id == id);
